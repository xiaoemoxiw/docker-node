...
JAVA_OPTS="-Xms1024m -Xmx1024m -XX:NewSize=512m -XX:MaxNewSize=512m -XX:+UseConcMarkSweepGC -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=${WORKER_LOG_DIR}  -XX:+DoEscapeAnalysis"
