...
JAVA_OPTS="-Xms5120m -Xmx5120m -XX:NewSize=1706m -XX:MaxNewSize=1706m -XX:+UseConcMarkSweepGC -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=${WORKER_LOG_DIR}  -XX:+DoEscapeAnalysis"
