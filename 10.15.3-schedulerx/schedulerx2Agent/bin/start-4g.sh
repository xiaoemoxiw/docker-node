...
JAVA_OPTS="-Xms2048m -Xmx2048m -XX:NewSize=960m -XX:MaxNewSize=960m -XX:+UseConcMarkSweepGC -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=${WORKER_LOG_DIR}  -XX:+DoEscapeAnalysis"
